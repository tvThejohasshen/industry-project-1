document.addEventListener("DOMContentLoaded", function () {
    ...
    paragraph1.innerHTML = `<p>Welcome to Gardens by the Bay</p><img src="./Four square/1. Garden by the bay.jpg" style="width:50px; height:auto;">`;
    GardensbythebayMarker.bindPopup(paragraph1).openPopup();
        ...
        paragraph2.innerHTML = `<p>Welcome to Singapore botanic gardens</p> <img src="./Four square/2. Singapore Botanic Gardens.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph3.innerHTML = `<p>Welcome to National orchid Garden</p><img src="./Four square/3.National Orchid Garden.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph4.innerHTML = `<p>Welcome to Cloud Forest</p><img src="./Four square/4.cloud forest.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph5.innerHTML = `<p>Welcome to Singapore Zoo</p><img src="./Four square/5.Singapore Zoo.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph6.innerHTML = `<p>Welcome to Marina bay</p><img src="./Four square/6.Marina bay.jpg" style="width:50px; height:auto">`;
        ...
        paragraph7.innerHTML = `<p>Welcome to Marina bay</p><img src="./Four square/7.Singapore Flyer.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph8.innerHTML = `<p>Welcome to Singapore Discovery centre</p><img src="./Four square/8.singapore discovery centre.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph9.innerHTML = `<p>Welcome to Super tree Grove</p><img src="./Four square/9.Supertree Grove.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph10.innerHTML = `<p>Welcome to Sands Skypark Observataion Deck</p><img src="./Four square/10.Sands Skypark Observataion Deck.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph11.innerHTML = `<p>Welcome to China town</p><img src="./Four square/11.Chinatown.jpeg" style="width:50px; height:auto;">`;
        ...
        paragraph12.innerHTML = `<p>Welcome to Orchard road</p><img src="./Four square/12.Orchard road.jpg" style="width:50px; height;">`;
        ...
        paragraph13.innerHTML = `<p>Welcome to Buddha Tooth Relic Temple and Museum</p><img src="./Four square/13.Buddha Tooth Relic Temple and Museum.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph14.innerHTML = `<p>Welcome to Merlion Park</p><img src="./Four square/14.Merlion Park.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph15.innerHTML = `<p>Welcome to Water front Promenade</p><img src="./Four square/15.Waterfront Promenade.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph16.innerHTML = `<p>Welcome to Flower Dome</p><img src="./Four square/16.Flower Dome.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph17.innerHTML = `<p>Welcome to National Museum of Singapore</p><img src="./Four square/17.National Museum of Singapore.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph18.innerHTML = `<p>Welcome to Singapore Mass Rapid Transit</p><img src="./Four square/18.Singapore Mass Rapid Transit.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph19.innerHTML = `<p>Welcome to Jewel Changi Airport</p><img src="./Four square/19.Jewel Changi Airport.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph20.innerHTML = `<p>Welcome to Singapore cable cable</p><img src="./Four square/20.Singapore cable car.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph21.innerHTML = `<p>Welcome to Clarque Quay</p><img src="./Four square/21.Clarque Quay.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph22.innerHTML = `<p>Welcome to Night safari</p><img src="./Four square/22.Night safari.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph23.innerHTML = `<p>Welcome to Maxwell Food centre</p><img src="./Four square/23.maxwell food centre.jpg" style="width:50px; height:auto;">`;
        ...
        paragraph24.innerHTML = `<p>Welcome to Sri Thendayuthapani swami Temple </p><img src="./Four square/24.Sri Dhandayudhabani Swami Temple.jpg" style="width:50px; height:auto;">`;
